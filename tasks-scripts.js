...
async function getTasks() {
    try {
        const response = await fetch("http://"+frontend_address+"/tasks", {
            method: "GET",
            headers: {
...
async function completeTask(taskId) {
    try {
        const response = await fetch("http://"+frontend_address+"/tasks/complete", {
            method: "POST",
            headers: {
                "Authorization": getAuthorizationToken(),  // Ensure this token is correct
                "Content-Type": "application/json" // Ensure the content type is JSON
...
async function uncompleteTask(taskId) {
    try {
        const response = await fetch("http://"+frontend_address+"/tasks/uncomplete", {
            method: "POST",
            headers: {
                "Authorization": getAuthorizationToken(),  // Ensure this token is correct
                "Content-Type": "application/json" // Ensure the content type is JSON
...
async function updateTask(taskId, title, text) {
    try {
        const response = await fetch("http://"+frontend_address+"/tasks/update", {
            method: "POST",
            headers: {
                "Authorization": getAuthorizationToken(),  // Ensure this token is correct
                "Content-Type": "application/json" // Ensure the content type is JSON
...
async function deleteTask(taskId) {
    try {
        const response = await fetch("http://"+frontend_address+"/tasks/delete", {
            method: "POST",
            headers: {
                "Authorization": getAuthorizationToken(),  // Ensure this token is correct
                "Content-Type": "application/json" // Ensure the content type is JSON
...
async function createTask(title, text) {
    try {
        const response = await fetch("http://"+frontend_address+"/tasks/create", {
            method: "POST",
            headers: {
                "Authorization": getAuthorizationToken(),  // Ensure this token is correct
                "Content-Type": "application/json" // Ensure the content type is JSON
...
async function getTasksSummary() {
    try {
        const response = await fetch("http://"+frontend_address+"/tasks/summary", {
            method: "GET",
            headers: {
                "Authorization": getAuthorizationToken(),  // Ensure this token is correct
                "Content-Type": "application/json" // Ensure the content type is JSON
